class Skill {
  ...
  bindKey() {
    ...
    console.log(`王浩辰已加载技能：${keyName}-${this.name}`);
  }
  ...
  cast() {
    ...
    // TODO 显示释放技能的特效
    console.log(`王浩辰消耗了${this.cost}积分发动了技能——${this.name}！\n${this.desc}`)
  }
}
...
class SkillW extends Skill {
  constructor(main) {
    super(main,
      '虚鲲鬼步',
      '',
      '王浩辰发动在美国校队时领悟的绝技，20秒内可以100%接住篮球',
      10,
      1000,
      'W');
    this.duration = 20;  // 持续20秒
  }
